...
namespace Microsoft.Extensions.Configuration
{
    public class TyeConfigurationExtensionsTest
    {
        ...
        [Fact]
        public void GetServiceHost_WithoutBinding_GetsConnectionStringIfSet()
        {
            var builder = new ConfigurationBuilder();
            builder.AddInMemoryCollection(new Dictionary<string, string>()
            {
                { "connectionstrings:myservice", "expected.example.com" },
                { "service:myservice:host", "example.com" },
                { "service:myservice:port", "443" },
            });
            ...
            var result = configuration.GetServiceHost("myservice");
            Assert.Equal("expected.example.com", result);
        }

        [Fact]
        public void GetServiceHost_WithoutBinding_ReturnsNullIfNotFound()
        {
            var builder = new ConfigurationBuilder();
            builder.AddInMemoryCollection(new Dictionary<string, string>()
            {
        ...
        [Fact]
        public void GetServiceHost_WithoutBinding_CombinesHostAndPort()
        {
            var builder = new ConfigurationBuilder();
            builder.AddInMemoryCollection(new Dictionary<string, string>()
            {
                { "service:myservice:protocol", "https" }, // ignored
                { "service:myservice:host", "expected.example.com" },
                { "service:myservice:port", "5000" },
            });
            ...
            var result = configuration.GetServiceHost("myservice");
            Assert.Equal("expected.example.com:5000", result);
        }

        [Fact]
        public void GetServiceHost_WithoutBinding_WithoutHost_ReturnsNull()
        {
            var builder = new ConfigurationBuilder();
            builder.AddInMemoryCollection(new Dictionary<string, string>()
            {
        ...
        [Fact]
        public void GetServiceHost_WithoutBinding_WithoutPort_ReturnsNull()
        {
            var builder = new ConfigurationBuilder();
            builder.AddInMemoryCollection(new Dictionary<string, string>()
            {
        ...
        [Fact]
        public void GetServiceHost_WithBinding_GetsConnectionStringIfSet()
        {
            var builder = new ConfigurationBuilder();
            builder.AddInMemoryCollection(new Dictionary<string, string>()
            {
                { "connectionstrings:myservice:metrics", "expected.example.com" },
                { "service:myservice:metrics:protocol", "https" },
                { "service:myservice:metrics:host", "example.com" },
                { "service:myservice:metrics:port", "443" },
            });
            ...
            var result = configuration.GetServiceHost("myservice", "metrics");
            Assert.Equal("expected.example.com", result);
        }

        [Fact]
        public void GetServiceHost_WithBinding_CombinesHostAndPort()
        {
            var builder = new ConfigurationBuilder();
            builder.AddInMemoryCollection(new Dictionary<string, string>()
            {
                { "service:myservice:metrics:protocol", "https" }, // ignored
                { "service:myservice:metrics:host", "expected.example.com" },
                { "service:myservice:metrics:port", "5000" },
            });
        ...
        [Fact]
        public void GetServiceHost_WithBinding_IgnoresDefaultBinding()
        {
            var builder = new ConfigurationBuilder();
            builder.AddInMemoryCollection(new Dictionary<string, string>()
            {
