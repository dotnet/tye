...
For URIs, the Tye infrastructure will generate a set of environment variables using a well-known pattern. These environment variables will available through the configuration system and used by `GetServiceUri()`.
